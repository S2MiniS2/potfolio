        ...
        <div className="crayon-note mx-auto max-w-4xl p-8 md:p-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <span className="crayon-star text-xl text-pink-500">*</span>
              <p className="text-sm font-medium text-muted-foreground">About</p>
            </div>

            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
                <span className="marker-pink-sweep from-left animate-left is-visible">
                  AI를 똑똑하게 활용하는
                </span>
                <br />
                <span className="doodle-underline-pink inline-block">
                  프론트엔드 개발자입니다.
                </span>
              </h2>
              ...
              <p className="max-w-3xl text-base leading-8 text-foreground/80">
                ...
                프론트엔드 개발자입니다. 최근에는 AI 도구를 개발 생산성에
                자연스럽게 녹이고, 서비스 안에서 AI 기능이 어색하지 않게
                연결되는 방식을 고민하고 있습니다.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="memo-panel space-y-3">
                ...
                <span className="doodle-underline-blue inline-block text-sm font-semibold text-sky-700">
              ...
              <div className="memo-panel space-y-3">
                ...
                <span className="crayon-star inline-block text-lg text-red-400">
                  *
                </span>
              </div>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-red-100 bg-white/60 px-5 py-4">
              ...
              <p className="mt-2 text-sm leading-7 text-foreground/75">
                사용자가 어디에서 막히는지 먼저 이해하고, 그 다음에 코드를
                설계하는 개발자가 되고 싶습니다.
              </p>
            </div>
          </div>
